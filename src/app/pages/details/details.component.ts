...
export class DetailsComponent implements OnInit {
  ...
  constructor(private service:ShowApiService,private router:ActivatedRoute,private title:Title,private meta:Meta) { }
  ...
  getshow(id:any){
    this.service.getDetails(id).subscribe(async(result)=>{
